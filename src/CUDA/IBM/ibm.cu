...
void gpuForceInterpolationSpread(
    ParticleNodeSoA* const restrict particlesNodes,
    ParticleCenter* const restrict particleCenters,
    Macroscopics* const restrict macr)
{
...
__global__
void gpuResetNodesForces(ParticleNodeSoA* const restrict particleNodes){
